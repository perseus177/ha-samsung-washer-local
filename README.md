...
| `button` Start selected programme | Sends 1–4. Not the same as plain **Start / resume**, which writes only `Run` — that one resumes a paused cycle, which this one deliberately will not do. |
